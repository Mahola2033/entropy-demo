...
import { aufholen, deckelMelden } from "./aufholen.js?v=0.9.26";
import { STAND } from "./data.js?v=0.9.26";
import { speichern, zuruecksetzen } from "./save.js?v=0.9.26";
import { cacheLeeren } from "./systeme.js?v=0.9.26";
import { zeitfaktorVon, zeitfaktorSetzen } from "./state.js?v=0.9.26";
