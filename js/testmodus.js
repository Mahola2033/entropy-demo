...
import { aufholen, deckelMelden } from "./aufholen.js?v=0.9.9";
import { STAND } from "./data.js?v=0.9.9";
import { speichern, zuruecksetzen } from "./save.js?v=0.9.9";
import { cacheLeeren } from "./systeme.js?v=0.9.9";
import { zeitfaktorVon, zeitfaktorSetzen } from "./state.js?v=0.9.9";
