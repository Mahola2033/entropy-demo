...
import { GALAXIE_REGELN, SPIELER_FRAKTION, TYP_SYMBOL } from "./data.js?v=0.9.48";
import { systemPosition, systemName, sternFuer } from "./galaxie.js?v=0.9.48";
import { flottePosition, schiffeText, flotteRestreichweite } from "./flotten.js?v=0.9.48";
import { holeSystem, objektGesperrt } from "./systeme.js?v=0.9.48";
import {
  planetenVon,
  planetAn,
  eigenerPlanetAn,
...
import { stromFuer } from "./zufall.js?v=0.9.48";
import { t, sprache } from "./sprache.js?v=0.9.48";
import { listeAbgleichen, attributSetzen, textSetzen, fmtDauer } from "./ui.js?v=0.9.48";
