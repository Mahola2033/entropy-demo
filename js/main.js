...
import { laden, speichern } from "./save.js?v=0.9.36";
import { zeitfaktorAnwenden } from "./state.js?v=0.9.36";
import { vorspulenBisJetzt } from "./simulation.js?v=0.9.36";
import {
  aufholen,
  aufholenLaeuft,
  grosseLuecke,
...
import { testmodusEinrichten } from "./testmodus.js?v=0.9.36";
import { spracheLaden, t } from "./sprache.js?v=0.9.36";
import { phase, stockungenBeobachten, stockungsBericht } from "./stockung.js?v=0.9.36";
import { KACHELWAECHTER_ZUSTAENDE } from "./kachelwaechter-zustaende.js?v=0.9.36";
import { kachelnBilanz, KACHEL_BEREICHE, kachelArtenGerendert, kachelKatalogAbgleich } from "./kachelwaechter.js?v=0.9.36";
