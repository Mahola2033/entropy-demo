...
import { vorspulenBisJetzt, vorspulenSchrittweise } from "./simulation.js?v=0.9.6";
import { spielzeitJetzt, meldungHinzufuegen } from "./state.js?v=0.9.6";
import { phase } from "./stockung.js?v=0.9.6";
