...
import { vorspulenBisJetzt, vorspulenSchrittweise } from "./simulation.js?v=0.9.26";
import { spielzeitJetzt, meldungHinzufuegen } from "./state.js?v=0.9.26";
import { phase } from "./stockung.js?v=0.9.26";
